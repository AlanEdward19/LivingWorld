...
public static class LivingEventPresentationCatalog
{
    private static readonly IReadOnlyDictionary<WorldEventKind, string> Labels =
        new Dictionary<WorldEventKind, string>
        {
            ...
            [WorldEventKind.CombatEncounterStarted] = "Um confronto começou entre habitantes",
            [WorldEventKind.CombatRound] = "Um confronto avançou para outro round",
            [WorldEventKind.PlantMatured] = "Uma planta atingiu maturidade",
            [WorldEventKind.PossessionResisted] = "Um habitante resistiu a uma possessão",
