...
/// <summary>Nível de espaço endereçável (Fase 15.1, T46/ADR-0017) — mesmos três níveis de
...
/// <summary>Andar sem unidade física (Fase 15.1, T46/ADR-0017) — inteiro livre, <see
...
/// <summary>Endereço espacial completo (Fase 15.1, T46/ADR-0017): nível, referência ao
