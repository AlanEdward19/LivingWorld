# ADR-0004: Interface `ILlmProvider` agora, provider concreto na Fase 11
...
## Contexto
A LLM só entra na Fase 11. Escolher provider hoje significa escolher com base em preço,
...
O provider real (Ollama local, Claude API, ou ambos) é escolhido na Fase 11, num ADR novo.
...
- **Follow-ups**: ADR-0008 na Fase 11 escolhendo o provider e registrando custo/latência.
