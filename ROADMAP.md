...
| 1 | [Motor de tempo](docs/roadmap/phase-01-time.md) | Calendário, ticks, scheduler, pausa/velocidade, snapshot, hash | pendente |
| 2 | [Geografia mínima](docs/roadmap/phase-02-geography.md) | Regiões, células, terreno, bioma, recursos, custo de deslocamento — só dados | pendente |
